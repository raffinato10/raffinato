  ...
  return (
    ...
    >
      ...
      {videoThumbnail ? (
        ...
        >
          <Image src={videoThumbnail} alt={review.customer_name} fill sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" className="object-cover transition-transform duration-500 group-hover/media:scale-105" draggable={false} />
